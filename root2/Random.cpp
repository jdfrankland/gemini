...
//alternative random nmber generator, using 
// the root TRandom3 generator
// requires root to be installed on your computer

CRandom* CRandom::fInstance = 0;  // mod-TU

CRandom* CRandom::instance() // mod-TU
{
    if (fInstance == 0) {
